...
public:
	...
	virtual Activity DRAW( void );
	virtual Activity DRAW_EMPTY( void );
	virtual bool	DefaultDeploy( char *szViewModel, char *szWeaponModel, int iActivity, char *szAnimExt );
	virtual bool	DefaultDeployFirst( char *szViewModel, char *szWeaponModel, int iActivity, char *szAnimExt );
...
CNetworkVar(int, m_nHolsterStage);
CNetworkVar(float, m_flHolsterAnimEndTime);
virtual bool CanHolster(void) const { return true; }
virtual void HandleHolster(void);
int GetHolsterActivity(void);
