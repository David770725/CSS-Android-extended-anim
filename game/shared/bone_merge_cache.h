...
public:
	...
	void CopyFromFollow( const Vector followPos[], const Quaternion followQ[], int boneMask, Vector myPos[], Quaternion myQ[] );
	void CopyToFollow( const Vector myPos[], const Quaternion myQ[], int boneMask, Vector followPos[], Quaternion followQ[] );
	bool IsCopied( );
