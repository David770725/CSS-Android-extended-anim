...
void CCSPlayer::Precache()
{
	...
	PrecacheModel ( "models/hand/hand.mdl" );
...
GetViewModel(1)->SetModel( "models/hand/hand.mdl" );
	}
...
if (m_afButtonPressed & IN_HOLSTER)
	HolsterButtonPressed();

if (m_afButtonReleased & IN_HOLSTER)
	 HolsterButtonReleased();
...
bool CCSPlayer::IsInspecting(void) const
{
...
void CCSPlayer::InspectButtonPressed(void)
{
	if (!FlashlightIsOn())
		FlashlightTurnOn();
	else
...
void CCSPlayer::InspectButtonReleased(void)
{
}


bool CCSPlayer::IsHolster(void) const
{
	if (m_nButtons & IN_HOLSTER)
		return true;

	return false;
}

void CCSPlayer::HolsterButtonPressed(void)
{
	if (!FlashlightIsOn())
		FlashlightTurnOn();
	else
...
void CCSPlayer::HolsterButtonReleased(void)
{
}
